...
$plugin->version  = 2020061500;   // The (date) version of this module + 2 extra digital for daily versions
...
$plugin->component = 'local_modulecompetency';
$plugin->cron     = 0;
$plugin->release = '1.0 (Build: 2020061500)';
